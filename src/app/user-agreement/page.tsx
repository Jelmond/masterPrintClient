            ...
            <StyledContainer>
                ...
                <StyledContent>
                    ...
                    <StyledSection>
                        ...
                        <StyledText>
                            5.3. При заказе на сумму от 300,00 (триста) белорусских рублей предоставляется скидка 5% на товары.
                        </StyledText>
                        <StyledText>
                            5.4. При заказе на сумму от 700,00 (семьсот) белорусских рублей предоставляется скидка 10% на товары.
                        </StyledText>
                        <StyledText>
                            5.5. При заказе на сумму от 1500,00 (одна тысяча пятьсот) белорусских рублей предоставляется скидка 20% на товары.
                        </StyledText>
                        <StyledText>
                            5.6. При выборе самовывоза предоставляется дополнительная скидка 3% на товары.
                        </StyledText>
                        <StyledText>
                            5.7. Способы оплаты: наличными или банковской картой при самовывозе, через систему ЕРИП,
                            банковской картой через Альфа-банк, расчётный счёт (для юридических лиц).
                        </StyledText>
                        <StyledText>
                            5.8. Оплата заказа должна быть произведена в течение 3 (трёх) рабочих дней с момента оформления заказа,

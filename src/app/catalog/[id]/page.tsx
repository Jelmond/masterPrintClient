...
const CATALOG_SEO_CONTENT: Record<string, React.ReactNode> = {
    'present-box': (
        <>
            <h1>Производство подарочных коробок на заказ</h1>
            ...
            <h2>Почему выбирают нас для изготовления подарочных коробок?</h2>
            ...
            <h2>Как заказать подарочные коробки?</h2>
            <p>Процесс изготовления подарочных коробок на заказ в MPP Shop начинается с вашей заявки. Вы можете оставить запрос на сайте или связаться с менеджером. Мы обсуждаем требования: размеры, материал, тираж, дизайн и сроки. Наш специалист готовит предварительный расчет стоимости и предоставляет коммерческое предложение. После утверждения макета запускается производство. Мы ценим индивидуальный подход и высокое качество исполнения. Мы используем разные материалы и технологии отделки, чтобы создать упаковку, которая не только защищает товар, но и становится частью подарка. Фото готовых работ демонстрируют разнообразие конструкций и дизайнов — от лаконичных картонных коробок до роскошных VIP-вариантов с тиснением. Обращайтесь к нам, и мы поможем реализовать ваш проект.</p>
            <h2>Заключение</h2>
    ...
    'paper': (
        <>
            ...
            <h2>Преимущества покупки оптом</h2>
            <ul>

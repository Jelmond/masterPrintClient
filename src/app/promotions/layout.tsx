...
export const metadata: Metadata = generateMetadata({
    ...
    description:
        "Ключевые положения о скидках на продукцию ООО «Мастерпринт-Пак»: скидки за объём (5%, 10% и 20%), самовывоз 3%, суммирование с промокодами и акциями, кратковременные акции. Интернет-магазин mppshop.by.",
    keywords:

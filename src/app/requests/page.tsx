            ...
            <StyledContainer>
                ...
                <StyledContent>
                    <StyledSection>
                        ...
                        <StyledParagraph>
                            <strong>1.1.</strong> Электронные обращения подаются заявителем на официальном сайте интернет-магазина (mppshop.by) в разделе «Обращения», путем заполнения указанной ниже формы. Письменные обращения направляются почтовой корреспонденцией по адресу: 231761, г. Скидель, ул. Промышленная, 6Б.
                        </StyledParagraph>

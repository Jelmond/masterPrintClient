        ...
        <StyledPaymentPage>
            <StyledContainer>
                ...
                <StyledContent>
                    ...
                    <StyledSection>
                        <StyledSectionTitle>Для юридических лиц, индивидуальных предпринимателей и лицо, осуществляющее самостоятельную профессиональную деятельность:</StyledSectionTitle>
                        <StyledList>
                            <StyledListItem>
                    ...
                    <StyledSection>
                        ...
                        <StyledText>
                            При оплате банковской картой мы связываемся с вами по средствам э/почты или телефона, чтобы подтвердить заказ и уточнить срок доставки/ получения товара. После этого вы оплачиваете товар и забрать его на пункте выдачи или вам осуществляется доставка, в зависимости от выбранного вами способа доставки.
                        </StyledText>

...
export default async function Home() {
  ...
  return (
    <>
      ...
      <SeoContent>
        <h1>Полиграфическая продукция: полный спектр печатных изделий для вашего бизнеса</h1>
        <p>Полиграфическая продукция — это изделия, созданные с помощью технологий пе­чати. Заказ полиграфической продукции позволяет эффективно донести информацию о компании, её товарах и услугах до целевой аудитории. Качественная печать и продуманный дизайн помогают выделиться среди конкурентов и создать прочный имидж бренда.</p>
        <h2>Что такое полиграфическая продукция</h2>
        ...
        <h2>Как заказать полиграфическую продукцию</h2>

...
export const metadata: Metadata = generateMetadata({
  ...
  description: "Популярные товары и бестселлеры MPPSHOP. Самые востребованные открытки, конверты и упаковка. Проверенное качество. Лучший выбор покупателей. Доставка по Беларуси. Скидки до 20% на популярную продукцию.",
  keywords: "бестселлеры полиграфия, популярные открытки, лучшие конверты, топ продаж полиграфия, востребованная упаковка, хиты продаж mppshop",
});

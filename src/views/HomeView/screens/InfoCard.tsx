...
const cards = [
    ...
    },
    {
        icon: 'percentage',
        title: 'Удобные Цены',
        description: 'При заказах от 300р, 700р и 1500р скидки 5%, 10% и 20%, соответственно',
    },
    {
        icon: 'truck',
        title: 'Доставка Включена',
        description: 'Бесплатная доставка курьером при заказе от 200р для юридических лиц',
    },
]
